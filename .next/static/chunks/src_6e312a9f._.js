...
function DashboardPage() {
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChange"])({
                "DashboardPage.useEffect.unsubscribe": (user)=>{
                    ...
                    if (user) {
                        ...
                        const sessionManager = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionManager"].getInstance();
    ...
    const fetchCredentials = async ()=>{
        ...
        try {
            ...
            if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.uid)) return;
            const response = await fetch("/api/credentials?userId=".concat(currentUser.uid));
            if (response.ok) {
    ...
    const handleSignOut = async ()=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signOutUser"])();
            // Clear local state
            setUser(null);
            setCredentials([]);
...
//# sourceMappingURL=src_6e312a9f._.js.map