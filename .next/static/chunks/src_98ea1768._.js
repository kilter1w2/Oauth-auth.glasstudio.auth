...
const signInWithGoogle = async ()=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__d__as__signInWithPopup$3e$__["signInWithPopup"])(auth, googleProvider);
        return result.user;
    } catch (error) {
...
const signInWithEmail = async (email, password)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ac__as__signInWithEmailAndPassword$3e$__["signInWithEmailAndPassword"])(auth, email, password);
        return result.user;
    } catch (error) {
...
const signUpWithEmail = async (email, password, displayName)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ab__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(auth, email, password);
        if (displayName && result.user) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__al__as__updateProfile$3e$__["updateProfile"])(result.user, {
                displayName
            });
        }
        return result.user;
...
const resetPassword = async (email)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__a6__as__sendPasswordResetEmail$3e$__["sendPasswordResetEmail"])(auth, email);
    } catch (error) {
...
const onAuthStateChange = (callback)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(auth, callback);
};
...
const updateUserProfile = async (updates)=>{
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$9ccb475d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__al__as__updateProfile$3e$__["updateProfile"])(user, updates);
    } catch (error) {
...
const saveUserData = async (user)=>{
    try {
        var _user_providerData_;
        const userData = {
            email: user.email,
            displayName: user.displayName,
            photoURL: user.photoURL,
            provider: ((_user_providerData_ = user.providerData[0]) === null || _user_providerData_ === void 0 ? void 0 : _user_providerData_.providerId) || "email",
...
const getUserApiCredentials = async (userId)=>{
    try {
        ...
        return querySnapshot.docs.map((doc)=>{
            var _data_createdAt, _data_updatedAt, _data_lastUsed;
            const data = doc.data();
            return {
                id: doc.id,
                ...data,
                createdAt: ((_data_createdAt = data.createdAt) === null || _data_createdAt === void 0 ? void 0 : _data_createdAt.toDate()) || new Date(),
                updatedAt: ((_data_updatedAt = data.updatedAt) === null || _data_updatedAt === void 0 ? void 0 : _data_updatedAt.toDate()) || new Date(),
                lastUsed: ((_data_lastUsed = data.lastUsed) === null || _data_lastUsed === void 0 ? void 0 : _data_lastUsed.toDate()) || undefined
            };
        });
    } catch (error) {
...
const getFirebaseErrorMessage = (error)=>{
    if (!(error === null || error === void 0 ? void 0 : error.code)) return "An unknown error occurred";
    switch(error.code){
...
function LoginPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChange"])({
                "LoginPage.useEffect.unsubscribe": async (user)=>{
                    setUser(user);
                    setLoading(false);
                    if (user) {
                        // Save user data to Firestore
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveUserData"])(user);
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        setError(null);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithGoogle"])();
        // Auth state change will handle the redirect
        } catch (error) {
            console.error("Google sign-in error:", error);
            setError((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseErrorMessage"])(error));
    ...
    const handleEmailAuth = async (e)=>{
        ...
        try {
            if (isSignUp) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpWithEmail"])(email, password);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmail"])(email, password);
            }
        // Auth state change will handle the redirect
        } catch (error) {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Access your developer dashboard and manage your applications"
                        }, void 0, false, {
                            fileName: "[project]/src/app/auth/login/page.tsx",
                            lineNumber: 109,
                            columnNumber: 11
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: isAuthenticating ? "Processing..." : isSignUp ? "Create Account" : "Sign In"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/auth/login/page.tsx",
                                        lineNumber: 219,
                                        columnNumber: 15
...
_s(LoginPage, "0hfb2my7ATAUzPkVs6BkI014+u0=", false, function() {
    return [
...
//# sourceMappingURL=src_98ea1768._.js.map